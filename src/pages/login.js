...
const LoginPage = () => {
    ...
    return (
        <Container>
            ...
            <Box borderRadius={8} borderWidth={1} boxShadow='lg' maxWidth='500px' my={4} p='8' textAlign='left'>
                <Stack align='center' maxW='md' spacing={2} w='full'>

                    <Button leftIcon={<FcGoogle />} onClick={signInWithGoogle} variant='outline' w='full'>
                        <Center>
